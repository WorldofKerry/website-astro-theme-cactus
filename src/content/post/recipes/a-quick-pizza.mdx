...
1. Spread sauce on dough, then add cheese, meats.
1. Transfer pizza onto tray or rack and put in oven for 5 min on middle rack.
   - As timer expires, check for doneness, if not done, check again in 2 min.
   - Remove from oven, add basil leaves on top.
...
- Check the doneness of crust vs toppings, adjust position in oven accordingly
   - Often this can vary due to how the oven cycle aligns with the cooking time
- Toppings that are better crisped up / burnt should be put on the very top
